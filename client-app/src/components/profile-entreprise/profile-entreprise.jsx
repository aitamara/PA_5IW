...
class ProfilePro extends React.Component {
    ...
    /*
        ...
        joinCommu.onclick = function () {
            joinCommu.style.display = "none";
            quiteCommu.style.display = "block";
            swipesTime.style.display = "block";
          };
    
          quiteCommu.onclick = function () {
            joinCommu.style.display = "block";
            quiteCommu.style.display = "none";
            swipesTime.style.display = "none";
          };
    */
    }
    render() {
